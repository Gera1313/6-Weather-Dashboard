...
function getWeatherIconClass(conditionCode, isDay) {
  ...
  switch (conditionCode) {
    case "01d":
    case "01n":
      return baseURL + "01" + (isDay ? "d" : "n") + ".png";
    case "02d":
    case "02n":
      return baseURL + "02" + (isDay ? "d" : "n") + ".png";
    case "03d":
    case "03n":
      return baseURL + "03" + (isDay ? "d" : "n") + ".png";
    case "04d":
    case "04n":
      return baseURL + "04" + (isDay ? "d" : "n") + ".png";
    case "09d":
    case "09n":
      return baseURL + "09" + (isDay ? "d" : "n") + ".png";
    case "10d":
    case "10n":
      return baseURL + "10" + (isDay ? "d" : "n") + ".png";
    case "11d":
    case "11n":
      return baseURL + "11" + (isDay ? "d" : "n") + ".png";
    case "13d":
    case "13n":
      return baseURL + "13" + (isDay ? "d" : "n") + ".png";
    case "50d":
    case "50n":
      return baseURL + "50" + (isDay ? "d" : "n") + ".png";
  }
}
